<div class="flex items-stretch flex-wrap bg-gray-200 h-auto">
    <div class="self-auto sm:self-start md:self-end lg:self-center xl:self-stretch w-1/2 p-4">
      <div>
        <img src="" alt="logo Cucho's">
      </div>
      <div class="flex content-center flex-wrap">
        <p class="font-bold w-full text-xl">Bienvenidos a Cucho's Market!</p>
        <p class="w-full">Crea una cuenta o <a class="link link-hover text-[#F5793B]">inicia sesión</a></p>
        <br>
        ...
        <div class="grid grid-cols-4 gap-4">
          ...
          <div class="m-2 col-span-2">
            ...
            <input type="text" id="name" placeholder="Ana" class="input input-bordered border-[#F5793B] max-w-xs" />
          </div>
          ...
          <div class="m-2 col-span-2">
            ...
            <input type="text" id="lastname" placeholder="Pérez" class="input input-bordered border-[#F5793B] max-w-xs" />
          ...
          <div class="form-control col-span-4 max-w-xs m-2">
            ...
            <input type="text" id="email" placeholder="ana@email.com" class="input input-bordered border-[#F5793B] w-full max-w-xs" />
