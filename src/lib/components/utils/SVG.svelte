...
{#if name == 'cuchos-logo'}
	...
	>
		<g clip-path="url(#clip0_6_113)">
			<path
				d="M1244.75 405.126C1266.06 405.126 1283.33 387.851 1283.33 366.542C1283.33 345.233 1266.06 327.959 1244.75 327.959C1223.44 327.959 1206.17 345.233 1206.17 366.542C1206.17 387.851 1223.44 405.126 1244.75 405.126Z"
				stroke="#F5793B"
				stroke-width="23"
			...
			/>
			<path
				d="M1456.96 405.126C1478.27 405.126 1495.54 387.851 1495.54 366.542C1495.54 345.233 1478.27 327.959 1456.96 327.959C1435.65 327.959 1418.38 345.233 1418.38 366.542C1418.38 387.851 1435.65 405.126 1456.96 405.126Z"
				stroke="#F5793B"
				stroke-width="23"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
			<path
				d="M1456.96 327.958H1244.75V57.875H1206.17"
				stroke="#F5793B"
				stroke-width="23"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
			<path
				d="M1244.75 96.459L1514.83 115.751L1495.54 250.792H1244.75"
				stroke="#F5793B"
				stroke-width="23"
				stroke-linecap="round"
				stroke-linejoin="round"
...
{:else if name == 'shopping-cart'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-shopping-cart"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'search'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-search"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'trash'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-trash"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'user-circle'}
	<svg
		...
		xmlns="http://www.w3.org/2000/svg"
	>
		<rect width="32" height="32" rx="16" fill="#F5793B" />
		<path
...
{:else if name == 'plus'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-plus"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'minus'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-minus"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'shopping-cart-plus'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-shopping-cart-plus"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'shopping-cart-x'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-shopping-cart-x"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'chevron-right'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-chevron-right font-semibold"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'arrow-narrow-right'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-arrow-narrow-right"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'arrow-narrow-left'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-arrow-narrow-left"
		width={size}
		height={size}
		viewBox="0 0 24 24"
		stroke-width={stroke}
...
{:else if name == 'x'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-x"
		width={size}
		height={size}
...
{:else if name == 'building-store'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="{props} stroke-current icon icon-tabler icon-tabler-building-store"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
	...
	>
		...
		<defs>
			<pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
				<use xlink:href="#image0_77_4502" transform="scale(0.00195312)" />
			</pattern>
		</defs>
	</svg>
{:else if name == 'coin'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-coins"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
...
{:else if name == 'shopping-bag'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-shopping-bag"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
...
{:else if name == 'affiliate'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-affiliate"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
...
{:else if name == 'map-pin'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-map-pin"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
...
{:else if name == 'settings'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-settings"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
...
{:else if name == 'chart-bar'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-chart-bar"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
...
{:else if name == 'users'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		class="stroke-current icon icon-tabler icon-tabler-users"
		width={size}
		height={size}
		viewBox="0 0 {size} {size}"
		stroke-width={stroke}
